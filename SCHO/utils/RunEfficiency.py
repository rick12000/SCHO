...
class ConformalRuntimeOptimizer:
    ...
    def get_optimal_number_of_secondary_model_parameter_combinations(primary_model_runtime,
        ...
        optimal_n_of_secondary_model_param_combinations = (
                ...
                secondary_model_runtime * secondary_model_runtime_as_frac_of_primary_model_runtime))
        optimal_n_of_secondary_model_param_combinations = int(round(optimal_n_of_secondary_model_param_combinations))
